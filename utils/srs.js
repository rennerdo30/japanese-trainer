...
function calculateNextReview(reviewData, quality) {
    if (!reviewData) {
        // First review
        return {
...
function getQualityFromResponse(isCorrect, responseTime, difficulty = 'normal') {
...
function getReviewPriority(reviewData) {
...
// Get mastery status
function getMasteryStatus(reviewData) {
